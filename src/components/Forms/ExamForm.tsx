...
const schema = z.object({
    ...
    img: z.any().refine((files) => files instanceof FileList && files.length > 0, {
        ...
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-2 w-full md:w-1/4">
                    ...
                    {errors.sex?.message && (
                        <p className="w-full text-xs text-red-400">{errors.sex.message.toString()}</p>
                    )}
                </div>
                <div className="flex flex-col gap-2 w-full md:w-1/4">
                    ...
                    {errors.img?.message && (
                        <p className="w-full text-xs text-red-400">{errors.img.message.toString()}</p>
                    )}
                </div>
            </div>
